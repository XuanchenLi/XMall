...
long ProductEntity::getStorageId() const
{
    return storageId;
}

void ProductEntity::setStorageId(long newStorageId)
{
...
QJsonObject ProductEntity::getJsonForm()
{
    return QJsonObject{
        ...
        {"unit",  unit},
        {"storageId", QString::number(storageId)},
...
ProductEntity ProductEntity::parseJson(QJsonObject obj)
{
    ...
    productEntity.setStorageId(obj["storageId"].toInteger());
